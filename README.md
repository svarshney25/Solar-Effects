...
This notebook detects and characterizes Coronal Mass Ejections (CMEs) by identifying simultaneous anomalies across multiple solar wind parameters such as proton density, velocity, temperature, flux, and geomagnetic activity (Kp index). It covers both Earth and Mars focused observations, creating a multi-planet view of the same CME events.
...
1. Setup & Data Loading - Mounts Google Drive, reads Mars CSV, and parses timestamps
...
Notes
- fillna(method='ffill') is used to forward-fill gaps in all datasets.
